 ...
 */
final class Version20210730165034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, quarter_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, user_id INT DEFAULT NULL, state_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, filename VARCHAR(255) NOT NULL, price INT NOT NULL, status VARCHAR(255) NOT NULL, area INT DEFAULT NULL, room INT NOT NULL, published TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL, featured TINYINT(1) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX IDX_8BF21CDEBED4A2B2 (quarter_id), INDEX IDX_8BF21CDE7E3C61F9 (owner_id), INDEX IDX_8BF21CDEA76ED395 (user_id), INDEX IDX_8BF21CDE5D83CC1 (state_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE property_type (property_id INT NOT NULL, type_id INT NOT NULL, INDEX IDX_93C6E813549213EC (property_id), INDEX IDX_93C6E813C54C8C93 (type_id), PRIMARY KEY(property_id, type_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE property_type ADD CONSTRAINT FK_93C6E813549213EC FOREIGN KEY (property_id) REFERENCES property (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE property_type ADD CONSTRAINT FK_93C6E813C54C8C93 FOREIGN KEY (type_id) REFERENCES type (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property_type DROP FOREIGN KEY FK_93C6E813C54C8C93');
